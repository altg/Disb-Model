...
The output of the model calculated from the 2 different methods **match**.
...
* The disbursement profiles for Not Disbursing and Disbursing Projects are very similar and are almost linear
