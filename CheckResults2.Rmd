...
```{r join with projected, eval=FALSE, include=FALSE}

comp1 <- 
  model_output_comp %>% 
  inner_join(model_input_comp_t , by = "project_id" ) %>% 
  mutate(
    days_from_approval_to_signature_res = days_from_approval_to_signature - days_from_approval_to_signature_act,
    days_from_signature_to_effectiveness_res = days_from_signature_to_effectiveness - days_from_signature_to_effectiveness_act,
    days_from_effectiveness_to_first_disbursement_res = days_from_effectiveness_to_first_disbursement -
      days_from_effectiveness_to_first_disbursement_act,
    days_from_first_to_final_disbursement_res = days_from_first_to_final_disbursement - days_from_first_to_final_disbursement_act
  )
