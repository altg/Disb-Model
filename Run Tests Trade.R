...
file.copy("Inputs/isdb_test_prjs.csv", "Inputs/isdb_test_trade_check.csv" , overwrite = T) 
file.copy("Outputs/model_output.rda" , "Outputs/model_trade_output_check.rda" , overwrite = T)
file.copy("Outputs/full_disb_profile.rda" , "Outputs/full_trade_disb_profile_check.rda" , overwrite = T)